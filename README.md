...
![散らばった業務情報を memory vault で整理し、LLM が回答や提案に使う流れ](docs/assets/llm-context-flow.png)

散らばった議事録、チャット、表計算、資料 URL を entity 別の memory vault に整理し、必要な文脈だけを LLM が読んで回答や提案に使う流れです。
